...
// -- Setting Initial States
      ...
      frameOneTl
        .set([logo, txt4, cta],  { opacity:0, y: 18, force3D: true, rotation: 0.0001})
        .set([bg, clouds], {x: 1, scale: 1.1, y: -20, force3D: true, rotation: 0.0001})
        .set([towerCon], {opacity: 1, y: -185, transformOrigin: "250px 394px", force3D: true, rotation: 0.0001})
        .set([bucket, bucketCon1, bucketCon2], {opacity: .8, force3D: true, rotation: 0.0001})
        .set([topDataCon1, topDataCon2], {opacity: .4, force3D: true, rotation: 0.0001})
        .set([tower], {opacity: 1, force3D: true, rotation: 0.0001})
        .set([txt1, txt2, txt3, flashlight, sparkles1, man, product], {opacity: 0, force3D: true, rotation: 0.0001})
...
// -- Bottom Data Animation 
        ...
        .to([bottomDataCon2], 7, 
          {opacity: .4, y: 120, ease: Power2.easeOut}, "sync-=.5")
        .to([bottomData], 7, 
          {opacity: 0, ease: Power2.easeOut}, "sync-=.5")
        .to([bottomDataCon1], 2, 
          {opacity:0}, "synco+=.1")
...
// -- Bucketman Animation
      ...
      // -- Vertical Reveal
        .to([bucketCon1], 3, 
          {y: -100, ease: Power2.easeOut}, "sync2-=7.2")
        .to([bucketCon2], 3, 
          {y: 100, ease: Power2.easeOut}, "sync2-=7.2")
        .to([man], 1, {opacity: .7}, "-=6")
        .to([flashlight], .2, {opacity:1}, "-=5")
...
// -- Top Data Animation
        ...
        .to([topDataCon1], 8, {opacity: 0, y: 300}, "sync+=1.5")
...
// -- Particle Animation
    ...
    function frameThree() {
      ...
      frameThreeTl
        .to([], .3, {onComplete: frameFour}, "sync-=10")
        // .to([logo_1], 1, {opacity:0, y:30})
        
    }

    function frameFour() {
      TweenMax.set([bgff],  { opacity:0})
      TweenMax.set([product], {opacity:0, y:150})
      TweenMax.set([sheen, sheenCont], {opacity: 1, y: -1})
      TweenMax.set([bgff, bgfront], {scale:2, y:-50, opacity: 0, transformOrigin: "150px 125px"})
      frameFourTl = new TimelineMax();
      frameFourTl
        .to([bg, clouds], 1.8, {y: 120, ease: Power4.easeInOut}, "sync")
        .to([towerCon, logo_1], 1.8, {y: 120, opacity: .4, ease: Power4.easeInOut}, "sync+=.1")
        
        .to([bgff], 1, {opacity: 1, scale: 1, y:0, ease: Power4.easeOut}, "sync1-=1")
        .to([bgfront], 1, {opacity: 1, scale: 1, y:0, ease: Power4.easeOut}, "sync1-=1")
        .staggerTo([logo, txt4, cta], 2, {y:0, opacity:1, ease: Power3.easeOut}, 0.4, "-=.8")
        .to([product], 2.4, {delay: .7, opacity: 1, y: 0, ease: Power3.easeOut}, "-=3")
        .from(sheen, 2, {x:-200,  ease:Power3.easeInOut}, "-=1")
